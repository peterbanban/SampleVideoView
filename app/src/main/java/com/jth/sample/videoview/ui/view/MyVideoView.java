 ...
 * 去除 SubtitleController.Anchor (不知道这个字幕功能是哪里用到的)接口
 * RenderingWidget mSubtitleWidget;  RenderingWidget.OnChangedListener
 */
...
//            }
    ...
    private void toggleMediaControlsVisiblity() {
        Log.e("123", "toggleMediaControlsVisiblity:" + mMediaController.isShowing());
